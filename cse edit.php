...
if(isset($_POST['submit'])){
    ...
    $sql="update cse set ".$sub."=".$mark." where id=".$id."";
    ...
    <div style="background-color: #226e93;height: 670px;">
        <div class="row register-form" style="height: 0;">
            <div class="col-md-8 offset-md-2" style="height: 0;">
                <form class="custom-form" style="height: 0600px;" method="post" id="forme" action="cse edit.php?id=<?php echo $id; ?>">
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="col-sm-4 input-column"><select name="subject" class="form-control"><option value="me">ME</option><option value="dbms">DBMS</option><option value="cn">CN</option><option value="unix">UNIX</option><option value="adp">ADP</option><option value="atc">ATC</option></select></div>
                    </div><button class="btn btn-light submit-button" form="forme" name="submit" type="submit">Done</button><button class="btn btn-danger active submit-button" onclick="location.href='cse.php'" type="button">cancel</button></form>
            </div>
        </div>
    </div>
