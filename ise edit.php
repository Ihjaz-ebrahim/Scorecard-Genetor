...
if(isset($_POST['submit'])){
    ...
    $sql="update ise set ".$sub."=".$mark." where id=".$id."";
    ...
    <div style="background-color: #226e93;height: 670px;">
        <div class="row register-form" style="height: 0;">
            <div class="col-md-8 offset-md-2" style="height: 0;">
                <form class="custom-form" style="height: 0600px;" method="post" id="forme" action="ise edit.php?id=<?php echo $id; ?>">
                    ...
                    </div><button class="btn btn-light submit-button" form="forme" name="submit" type="submit">Done</button><button class="btn btn-danger active submit-button" onclick="location.href='ise.php'" type="button">cancel</button></form>
            </div>
        </div>
    </div>
