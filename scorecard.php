...
<body>
    <div style="background-color: #226e93;"><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal1" onclick="location.href='home.php'" style="background-color: rgb(34,110,147);">Back</button>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-left" style="font-weight: bold;color: rgb(34,110,147);font-size: 24px;line-height: 66px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Scorecard Generator&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal1" onclick="location.href='Scorecard add.php'" style="background-color: rgb(34,110,147);">Search Student</button></h1>
                </div>
            </div>
        </div>
    </div>
