...
<body>
    <div style="background-color: #226e93;"><button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal1" onclick="location.href='home.php'" style="background-color: rgb(34,110,147);">Back</button>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-left" style="font-weight: bold;color: rgb(34,110,147);font-size: 24px;line-height: 66px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; INFORMATION SCIENCE AND ENGINEERING&nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#modal1" onclick="location.href='ise add.php'" style="background-color: rgb(34,110,147);">ADD STUDENT</button></h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <table class="table table-bordered table-hover">
                <thead class="bill-header cs" style="width: 800px;">
                    <tr style="width: 900px;">
                        ...
                        <th id="trs-hd" class="col-lg-2" style="width: 500px;">CN</th>
                        <th id="trs-hd-2" class="col-lg-2" style="width: 500px;">DBMS</th>
                        <th id="trs-hd" class="col-lg-3" style="width: 500px;">ME</th>
                        <th id="trs-hd" class="col-lg-2" style="width: 500px;">ATC</th>
                        <th id="trs-hd" class="col-lg-2" style="width: 500px;">UNIX</th>
                        <th id="trs-hd-1" class="col-lg-2" style="width: 500px;">ADP</th>
...
?>
     ...
     <script type="text/javascript">
        function edit(id){
           location.href="ise edit.php?id="+id;
