...
if(isset($_POST['submit'])){
    ...
    $sql="update me set ".$sub."=".$mark." where id=".$id."";
    ...
    <div style="background-color: #226e93;height: 670px;">
        <div class="row register-form" style="height: 0;">
            <div class="col-md-8 offset-md-2" style="height: 0;">
                <form class="custom-form" style="height: 0600px;" method="post" id="forme" action="me edit.php?id=<?php echo $id; ?>">
                    ...
                    <div class="form-row form-group">
                        ...
                        <div class="col-sm-4 input-column"><select name="subject" class="form-control"><option value="me">ME</option><option value="Dme">DME</option><option value="fp">FP</option><option value="om">OM</option><option value="dom">DOM</option><option value="tm">TM</option></select></div>
                    </div><button class="btn btn-light submit-button" form="forme" name="submit" type="submit">Done</button><button class="btn btn-danger active submit-button" onclick="location.href='me.php'" type="button">cancel</button></form>
            </div>
        </div>
    </div>
