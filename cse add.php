...
$name=$_POST['name'];
    ...
    $me=$_POST['me'];
    $atc=$_POST['atc'];
    $sql="insert into cse(`name`, `unix`, `dbms`, `cn`, `adp`, `me`, `atc`) values( '".$name."',".$unix.",".$dbms.",".$cn.",".$adp.",".$me.",".$atc.")";
    ...
    <div style="background-color: #226e93;height: 1000px;color: rgb(240,250,255);">
        <div class="row register-form" style="height: 0;">
            <div class="col-md-8 offset-md-2" style="height: 0;">
                <form class="custom-form" style="height: 800px;" action="cse add.php" method="post">
                    <h1>Add Menu</h1>
                    ...
                    </div><button class="btn btn-light submit-button" name="add" type="submit">Done</button><button class="btn btn-danger active submit-button" onclick="location.href='cse.php'" type="button">cancel</button></form>
            </div>
        </div>
    </div>
